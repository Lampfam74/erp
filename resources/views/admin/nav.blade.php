    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <a class="navbar-brand mt-2 mt-lg-0" href="#">
          <img src="../../img/l1.png" height="70px" alt="MDB Logo" loading="lazy" />
        </a>
        <!-- Left links -->
        ...
        <li class="nav-item"><a class="nav-link" href="{{route('cdd.index')}}">Liste Des CDD</a>
        </li>
        <li class="nav-item">
      ...
      @endif
        ...
        <li class="nav-item">
        <a class="nav-link" href="{{route('cdd.index')}}">Liste Des CDD</a>
        </li>
        <li class="nav-item">
      ...
      @endif
        ...
        <!-- <li class="nav-item">
                         <a class="nav-link" href="{{route('cdi.index')}}">Liste Des CDI</a>
                         </li> -->
        <li class="nav-item">
        <a class="nav-link" href="{{route('cdd.index')}}">Liste Des CDD</a>
        </li>
      ...
      <div class="d-flex align-items-center">
        <div class="dropdown d-inline-block ml-2">
          <a class="header-item waves-effect" style="color:aliceblue" data-toggle="dropdown" aria-haspopup="true"
            aria-expanded="false">
            {{-- <img class="rounded-circle header-profile-user" src="assets/images/users/avatar-2.jpg" alt=""> --}}

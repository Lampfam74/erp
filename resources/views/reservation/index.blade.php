    ...
    <table id="tabsous" class="table align-middle mb-0 bg-white ">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><a href="{{route('reservation.show',$per->id)}}" class="btn btn-link btn-sm btn-rounded">Editer </a></td>
            </tr>
            @endforeach
        </tbody>
        {{-- <script>
    ...
    <div class="modal-dialog">
        <div class="modal-content container">
            <div class="modal-header" >
                ...
                width:  auto;
                 ">
                <form action="{{ route('reservation.store') }}" method="POST" style=" color: white;" enctype="multipart/form-data">
                    @csrf
                    ...
                    <input type="text" class="form-control" class="@error('rccm') is-invalid @enderror" id="exampleFormControlInput1" name="rccm"
                        placeholder="">
